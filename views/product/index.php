                    ...
                    <ul class="product-list">
                            ...
                            <div class="row">
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a href="#" class="thumb-holder">
                                        <img alt="" src="../../web/home/images/blank.gif" data-echo="<?php echo \Yii::$app->params['homeImagesDir']?>products/product-small-01.jpg" />
                                    </a>
                                </div>
                        ...
                        <li>
                            <div class="row">
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a href="#" class="thumb-holder">
                                        <img alt="" src="../../web/home/images/blank.gif" data-echo="<?php echo \Yii::$app->params['homeImagesDir']?>products/product-small-02.jpg" />
                                    </a>
                                </div>
                                <div class="col-xs-8 col-sm-8 no-margin">
                        ...
                        <li>
                            <div class="row">
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a href="#" class="thumb-holder">
                                        <img alt="" src="../../web/home/images/blank.gif" data-echo="<?php echo \Yii::$app->params['homeImagesDir']?>products/product-small-03.jpg" />
                                    </a>
                                </div>
                                <div class="col-xs-8 col-sm-8 no-margin">
                                    <a href="#">PowerShot Elph 115 16MP Digital Camera</a>
                                    ...
                                    <div class="row no-margin">
                                        ...
                                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                            <div class="product-item">
                                                <div class="ribbon red"><span>sale</span></div>
                                                <div class="image">
                                                    <img alt="" src="../../web/home/images/blank.gif" data-echo="<?php echo \Yii::$app->params['homeImagesDir']?>products/product-01.jpg" />
                                                </div>
                                                <div class="body">
                                        ...
                                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                            <div class="product-item">
                                                <div class="ribbon blue"><span>new!</span></div>
                                                <div class="image">
                                                    <img alt="" src="../../web/home/images/blank.gif" data-echo="<?php echo \Yii::$app->params['homeImagesDir']?>products/product-02.jpg" />
                                                </div>
                                                <div class="body">
                                        ...
                                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                            <div class="product-item">
                                                <div class="image">
                                                    <img alt="" src="../../web/home/images/blank.gif" data-echo="<?php echo \Yii::$app->params['homeImagesDir']?>products/product-03.jpg" />
                                                </div>
                                                <div class="body">
                                                    <div class="label-discount clear"></div>
                                                    <div class="title">
                                        ...
                                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                            <div class="product-item">
                                                ...
                                                <div class="ribbon green"><span>bestseller</span></div>
                                                <div class="image">
                                                    <img alt="" src="../../web/home/images/blank.gif" data-echo="<?php echo \Yii::$app->params['homeImagesDir']?>products/product-04.jpg" />
                                                </div>
                                                <div class="body">
                                                    <div class="label-discount clear"></div>
                                                    <div class="title">
                                ...
                                <div class="products-list">
                                    ...
                                    <div class="product-item product-item-holder">
                                        ...
                                        <div class="row">
                                            <div class="no-margin col-xs-12 col-sm-4 image-holder">
                                                <div class="image">
                                                    <img alt="" src="../../web/home/images/blank.gif" data-echo="<?php echo \Yii::$app->params['homeImagesDir']?>products/product-05.jpg" />
                                                </div>
                                            </div><!-- /.image-holder -->
                                            <div class="no-margin col-xs-12 col-sm-5 body-holder">
                                                <div class="body">
