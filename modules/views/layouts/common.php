...
<head>
    ...
    <!-- libraries -->
    <link href="<?php echo \Yii::$app->params['admin']['css']?>lib/jquery-ui-1.10.2.custom.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo \Yii::$app->params['admin']['css']?>lib/font-awesome.css" type="text/css" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="<?php echo \Yii::$app->params['admin']['css']?>compiled/index.css" type="text/css" media="screen" />
    <link href="<?php echo \Yii::$app->params['admin']['css']?>lib/bootstrap-wysihtml5.css" type="text/css" rel="stylesheet" />
    <link rel="stylesheet" href="<?php echo \Yii::$app->params['admin']['css']?>compiled/form-showcase.css" type="text/css" media="screen" />
    <!-- open sans font -->
...
<div class="navbar navbar-inverse">
    <div class="navbar-inner">
        ...
        <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei"><?php echo \Yii::$app->params['admin']['title']?></a>
            ...
            <li class="notification-dropdown hidden-phone">
                ...
                <div class="pop-dialog">
                    ...
                    <div class="body">
                        ...
                        <div class="messages">
                            <a href="#" class="item">
                                <img src="<?php echo \Yii::$app->params['admin']['images']?>contact-img.png" class="display" />
                            ...
                            <a href="#" class="item">
                                <img src="<?php echo \Yii::$app->params['admin']['images']?>contact-img2.png" class="display" />
                                <div class="name">Alejandra Galván</div>
                                <div class="msg">
...
<script src="<?php echo \Yii::$app->params['admin']['js']?>jquery-ui-1.10.2.custom.min.js"></script>
<!-- knob -->
<script src="<?php echo \Yii::$app->params['admin']['js']?>jquery.knob.js"></script>
<!-- flot charts -->
<script src="<?php echo \Yii::$app->params['admin']['js']?>jquery.flot.js"></script>
<script src="<?php echo \Yii::$app->params['admin']['js']?>jquery.flot.stack.js"></script>
<script src="<?php echo \Yii::$app->params['admin']['js']?>jquery.flot.resize.js"></script>
<script src="<?php echo \Yii::$app->params['admin']['js']?>theme.js"></script>
<script src="<?php echo \Yii::$app->params['admin']['js']?>wysihtml5-0.3.0.js"></script>
<script src="<?php echo \Yii::$app->params['admin']['js']?>bootstrap-wysihtml5-0.0.2.js"></script>
